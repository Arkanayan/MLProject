...
delete('concrete_data_testing.csv');
delete('concrete_data_training.csv');
...
% write to csv file
dlmwrite('concrete_data_testing.csv',(run_testing_error), '-append');
dlmwrite('concrete_data_training.csv',run_training_error, '-append');
end
