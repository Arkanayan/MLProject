...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'E5');
...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'K5');
status
...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'Q5');
...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'W5');
...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'AC5');
...
[status] = runAndReportIFWA(Xnorm, ynorm, deMaxIter, no_of_iter, result_filename, 'AI5');
